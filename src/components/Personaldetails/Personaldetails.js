...
const PersonalDetails = () => {
  ...
  const handleCheckbox = () => {
    setValue("marriedUnderSpecialAct", "Yes");
  };
        ...
        >
                ...
                render={({ field }) => (
                  <RadioGroup
                    ...
                    onValueChange={(value) => {
                      ...
                      setIsForeign(value === "foreign"); // Then update local state
                    }}
                  >
                    <Label
          ...
          <div className="space-y-2">
            ...
            <Controller
              ...
              render={({ field }) => (
                ...
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Select countryOfResidence" />
                  </SelectTrigger>
                  <SelectContent>
          ...
          <div className="space-y-2 mt-6 gap-2 flex items-center">
            <Checkbox
              ...
              id="marriedUnderSpecialAct"
              {...register("marriedUnderSpecialAct")}
            />
            <Label
              className="flex items-center gap-2 mt-2"
              htmlFor="marriedUnderSpecialAct"
            >
              Married under Special Marriage Act
            </Label>
          </div>
          <div className="space-y-2">
            <Label htmlFor="correspondenceEmail">Correspondence Email</Label>
            <Controller
              ...
              render={({ field }) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    >
                      No
                      <RadioGroupItem id="email-different" value="" />
                    </Label>
                  </div>
                </RadioGroup>
              )}
            ...
            {!sameAsLoginEmail && (
              <div className="space-y-2 mt-2">
                <Label htmlFor="custom-email">correspondance Email</Label>
                <Input
              ...
              <>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    type="text"
                    {...register("drivingLicencePlaceOfIssue", {
                      required: "Place of issue is required",
                    })}
                  />
                  {errors.drivingLicencePlaceOfIssue && (
                    <span className="text-red-500">
                      {errors.drivingLicencePlaceOfIssue.message}
                    </span>
                  )}
                </div>
                <div className="space-y-2">
            ...
            {showPassportFields && (
              <>
                ...
                <div className="space-y-2">
                  ...
                  />
                  {errors.passportPlaceOfIssueOfIssue && (
                    <span className="text-red-500">
